...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<sf:form modelAttribute="cliente" action="alterar" method="post" id="idForm">	
		<div class="box">
			...
			<label>
				...
				<sf:input class="input_text" path="nome" maxlength="255" />
			</label>
			<label>
			...
			<label>
				...
				<sf:input class="input_text" path="email" maxlength="100" />
			</label>
			<label>
			...
			<label>
				...
				<sf:input class="input_text" path="endereco.logradouro" maxlength="100" />
			</label>
			<label>
				<span class="descricao">Número<span class="obrigatorio">*</span></span>
				<sf:input class="input_text" path="endereco.numero" maxlength="10" />
			</label>
			<label>
			...
			<label>
				...
				<sf:input class="input_text" path="endereco.bairro" maxlength="100" />
			</label>
			<label>
...
<script type="text/javascript">
	function voltar(){
		$('#idForm').prop('action', "<c:url value='/clienteController/detalhar?id=${cliente.id}&isAlterar=false' />");
		$('#idForm').submit();
	}
</script>